...
var current_totaldoses = current_first + current_second + current_third;
...
var yesterday_totaldoses = yesterday_first + yesterday_second + yesterday_third;
